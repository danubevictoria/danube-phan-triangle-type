...
public class TriangleTest extends TestCase {
	...
	public void testTriangleTypeInvalid(){
		...
		assertNull(Triangle.triangleType(0, 1, 1));
		assertNull(Triangle.triangleType(1, 0, 1));
		assertNull(Triangle.triangleType(1, 1, 0));
		assertNull(Triangle.triangleType(1, -1, 1));
		assertNull(Triangle.triangleType(-1, 1, 1));
		assertNull(Triangle.triangleType(1, 1, -1));
		assertNull(Triangle.triangleType(1, 1, null));
		assertNull(Triangle.triangleType(null, 1, 1));
		assertNull(Triangle.triangleType(1, null, 1));
	}
}
